...
export default function Home() {
  return (
    <div className="" style={{backgroundColor: "#edb939"}}>
      <div className="flex justify-center m-5 ml-72 mr-72 border-b-4 border-purple-900">
        <a href="https://github.com/MeerIsmailAli" target="_blank" className=" border-2 font-bold m-6 text-2xl text-purple-900">Github</a>
        <a href="mailto:meeraliakhil@gmail.com" target="_blank" className="border-2 font-bold m-6 text-2xl text-purple-900"> Email</a>
        <a href="https://github.com/MeerIsmailAli" target="_blank" className=" border-2 font-bold m-6 text-2xl text-purple-900">Twitter</a>
      </div>
